package matthewallenlinsoftware.languagesexample;
...
public class MainActivity extends Activity {
    ...
    final SharedPreferences sharedPreferences = this.getSharedPreferences("matthewallenlinsoftware.languagesexample", Context.MODE_PRIVATE);
